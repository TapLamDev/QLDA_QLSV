 ...
 * @author haops25533
 */
public class QLDCB extends javax.swing.JFrame {
    ...
    public void roleCB()
    {
        txtMaSVDiem.setEditable(false);
        txtDiemTA.setEditable(false);
        txtDiemTinHoc.setEditable(false);
        txtDiemGDTC.setEditable(false);
        txtHoTen.setEditable(false);
   ...
   public void newForm() 
   {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLDCB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
